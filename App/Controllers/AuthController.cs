...
using Shop.App.ViewModels.Auth;
...
namespace App.Controllers
{
    ...
    public class AuthController : ApiController
    {
        ...
        {
            //var HashPass = Sha256Hasher.Hash(register.Password);
            var command = new CreateUserCommand(register.UserName, register.PhoneNumber, register.Password);
